...
SECRET_KEY = 'django-insecure-39jq&_!_$8(ulxxnrv&ju@#m5tes#y&l#87a2rh$813ldp@-m)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Asegúrate de tener una carpeta 'templates'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
